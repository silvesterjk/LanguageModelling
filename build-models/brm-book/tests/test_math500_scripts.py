...
SCRIPT_PATHS = [
    Path("chapter-03/02_math500-verifier-scripts/evaluate_math500_batched.py"),
    Path("chapter-03/02_math500-verifier-scripts/evaluate_math500.py"),
    Path("chapter-03/02_math500-verifier-scripts/evaluate_json.py"),
    Path("chapter-04/02_math500-inference-scaling-scripts/self_consistency_math500.py"),
    Path("chapter-04/02_math500-inference-scaling-scripts/cot_prompting_math500.py"),
]
...
def test_evaluate_json_script_jsonl(tmp_path):
    ...
    repo_root = Path(__file__).resolve().parent.parent
    script_path = repo_root / "chapter-03/02_math500-verifier-scripts/evaluate_json.py"
