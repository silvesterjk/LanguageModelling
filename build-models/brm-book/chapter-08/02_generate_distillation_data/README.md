...
To calculate the accuracy of the model that generated the dataset (i.e., the teacher), use the [../../chapter-03/02_math500-verifier-scripts/evaluate_json.py](../../chapter-03/02_math500-verifier-scripts/evaluate_json.py) script:

```bash
uv run ../../chapter-03/02_math500-verifier-scripts/evaluate_json.py \
--json_path sample_openrouter_outputs.json \
