> **Attribution:** This directory contains selected materials from Sebastian Raschka's [*Build a Reasoning Model (From Scratch)*](https://github.com/rasbt/reasoning-from-scratch). The original work is licensed under the [Apache License 2.0](LICENSE). The imported top-level chapter directories have been renamed for consistency in this repository.
...
- [Troubleshooting Guide](https://github.com/rasbt/reasoning-from-scratch/blob/main/troubleshooting.md)

| Chapter Title                                               | Main Code                                                    |
| ----------------------------------------------------------- | ------------------------------------------------------------ |
| Ch 1: Understanding reasoning Models                        | No code                                                      |
| Ch 2: Generating Text with a Pre-trained LLM                | - [ch02_main.ipynb](chapter-02/01_main-chapter-code/ch02_main.ipynb)<br/>- [ch02_exercise-solutions.ipynb](chapter-02/01_main-chapter-code/ch02_exercise-solutions.ipynb) |
| Ch 3: Evaluating Reasoning Models                           | - [ch03_main.ipynb](chapter-03/01_main-chapter-code/ch03_main.ipynb)<br/>- [ch03_exercise-solutions.ipynb](chapter-03/01_main-chapter-code/ch03_exercise-solutions.ipynb) |
| Ch 4: Improving Reasoning with Inference-Time Scaling       | - [ch04_main.ipynb](chapter-04/01_main-chapter-code/ch04_main.ipynb)<br/>- [ch04_exercise-solutions.ipynb](chapter-04/01_main-chapter-code/ch04_exercise-solutions.ipynb) |
| Ch 5: Inference-Time Scaling via Self-Refinement            | - [ch05_main.ipynb](chapter-05/01_main-chapter-code/ch05_main.ipynb)<br/>- [ch05_exercise-solutions.ipynb](chapter-05/01_main-chapter-code/ch05_exercise-solutions.ipynb) |
| Ch 6: Training Reasoning Models with Reinforcement Learning | - [ch06_main.ipynb](chapter-06/01_main-chapter-code/ch06_main.ipynb)<br/>- [ch06_exercise-solutions.ipynb](chapter-06/01_main-chapter-code/ch06_exercise-solutions.ipynb) |
| Ch 7: Improving GRPO for Reinforcement Learning             | - [ch07_main.ipynb](chapter-07/01_main-chapter-code/ch07_main.ipynb)<br/>- [ch07_exercise-solutions.ipynb](chapter-07/01_main-chapter-code/ch07_exercise-solutions.ipynb) |
| Ch 8: Distilling Reasoning Models for Efficient Reasoning   | - [ch08_main.ipynb](chapter-08/01_main-chapter-code/ch08_main.ipynb)<br/>- [ch08_exercise-solutions.ipynb](chapter-08/01_main-chapter-code/ch08_exercise-solutions.ipynb) |
...
| Appendix C: Qwen3 LLM Source Code                           | - [chC_main.ipynb](chapter-C/01_main-chapter-code/chC_main.ipynb)  |
| Appendix D: Using larger LLMs                               | - [chD_main.ipynb](chapter-D/chD_main.ipynb)                       |
| Appendix E: Batching and throughput-oriented execution      | - [chE_main.ipynb](chapter-E/chE_main.ipynb)                       |
| Appendix F: Common Approaches to LLM Evaluation             | - [chF_main.ipynb](chapter-F/01_main-chapter-code/chF_main.ipynb)  |
| Appendix G: Building a Chat Interface                       | - [chG](chapter-G)                                                 |
...
(Please see the [setup_tips](chapter-02/02_setup-tips/python-instructions.md) doc for additional recommendations.)

&nbsp;
## Exercises

Each chapter of the book includes several exercises. The solutions are summarized in Appendix B, and the corresponding code notebooks are available in the main chapter folders of this repository (for example,  [`chapter-02/01_main-chapter-code/ch02_exercise-solutions.ipynb`](chapter-02/01_main-chapter-code/ch02_exercise-solutions.ipynb)).
...
- **Chapter 2: Generating Text with a Pre-trained LLM**
  - [Optional Python Setup and Cloud GPU Recommendations](chapter-02/02_setup-tips)
  - [Using a GPU-optimized version of the LLM](chapter-02/03_optimized-LLM)
  - [Using `torch.compile()` on Windows](chapter-02/04_torch-compile-windows)
  - [Run inference and chat with the model](chapter-02/05_use_model)
- **Chapter 3: Evaluating LLMs**
  - [MATH-500 Verifier Scripts](chapter-03/02_math500-verifier-scripts)
  - [Advanced Parser](chapter-03/03_advanced-parser) (hybrid LaTeX parser)
- **Chapter 4: Improving Reasoning with Inference-Time Scaling**
  - [Inference Scaling on MATH-500](chapter-04/02_math500-inference-scaling-scripts) (CoT prompting, self-consistency)
- **Chapter 5: Inference-Time Scaling Via Self-Refinement**
  - [More Inference Scaling on MATH-500](chapter-05/02_math500-more-inference-scaling-scripts) (Best-of-N, self-refinement)
- **Chapter 6: Training Reasoning Models with Reinforcement Learning**
  - [GRPO scripts](chapter-06/02_rlvr_grpo_scripts_intro) with a batched mode
- **Chapter 7: Improving GRPO for Reinforcement Learning**
  - [Advanced GRPO scripts](chapter-07/03_rlvr_grpo_scripts_advanced) (including DeepSeek-V3.2-, Olmo3-, and GDPO-style training)
  - [Download training checkpoints](chapter-07/04_download_trainining_checkpoints) (how to download and use the chapter 6 and 7 GRPO checkpoints)
- **Chapter 8: Distilling Reasoning Models for Efficient Reasoning**
  - [Generate distillation data](chapter-08/02_generate_distillation_data) (teacher-output generation via Ollama or OpenRouter)
  - [Train with distillation](chapter-08/04_train_with_distillation) (including single-example and batched distillation scripts)
  - [Download training checkpoints](chapter-08/05_download_training_checkpoints) (how to download and use the chapter 8 distillation checkpoints)
  - [Use Qwen3 with Hugging Face](chapter-08/06_use_via_huggingface) (how to use the base model and chapter 6-8 checkpoints with `transformers`)
- **Appendix F: Common Approaches to LLM Evaluation**
  - [MMLU Evaluation Methods](chapter-F/02_mmlu)
  - [LLM leaderboards](chapter-F/03_leaderboards)
  - [LLM-as-a-judge](chapter-F/04_llm-judge)
- **Appendix G: Building a Chat Interface**
  - [Chat interface code](chapter-G/01_main-chapter-code)


&nbsp;
## Questions, Feedback, and Contributing to This Repository

For common problems, please see the [Troubleshooting Guide](https://github.com/rasbt/reasoning-from-scratch/blob/main/troubleshooting.md).
